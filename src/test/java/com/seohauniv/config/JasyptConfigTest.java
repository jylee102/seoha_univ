...
public class JasyptConfigTest {
    ...
    void stringEncryptor() {
        ...
        System.out.println("host : " + jasyptEncoding(host));
        System.out.println("port : " + jasyptEncoding(port));
        System.out.println("username : " + jasyptEncoding(emailUsername));
        System.out.println("emailPassword : " + jasyptEncoding(emailPassword));
    }
